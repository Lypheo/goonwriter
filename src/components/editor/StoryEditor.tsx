        ...
        <div className="absolute top-3 left-3 z-30">
          {isLeftCollapsed && onExpandLeft && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-gray-300 bg-white text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:text-gray-900 transition-colors"
              title="Expand Left Sidebar (Library)"
        ...
        <div className="absolute top-3 right-3 z-30">
          {isRightCollapsed && onExpandRight && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-gray-300 bg-white text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:text-gray-900 transition-colors"
              title="Expand Right Sidebar (LLM Controls)"
      ...
      <div className="px-4 py-2.5 border-b border-gray-200 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          {isLeftCollapsed && onExpandLeft && (
            <button
              onClick={onExpandLeft}
              className="inline-flex items-center gap-1 p-1.5 rounded-md border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 hover:text-gray-900 transition-colors shrink-0"
              title="Expand Left Sidebar (Library)"
              aria-label="Expand Left Sidebar"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <h1 className="text-lg font-semibold text-gray-800 truncate">{selectedStory.name}</h1>
          {(() => {
            ...
            return (
              <button
                ...
                className="hidden md:flex items-center gap-1 text-xs text-gray-400 hover:text-gray-600 transition-colors shrink-0"
                title={`Cloned from: ${originStory.name}`}
              >
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
                <span className="truncate max-w-[150px]">cloned from {originStory.name}</span>
              </button>
            );
          })()}
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {isRightCollapsed && onExpandRight && (
            ...
            >
              ...
              <span className="hidden sm:inline">LLM Controls</span>
            </button>
          )}
        </div>
      </div>
